...
//package com.odenzo.xrpl.common
//
...
//
//  }
//  /** TODO: Place this more ergonomically into a ToArgument. This is also slow as.. */
...
//  }
//
//  given ToArgument[(String,Json)] = { tj =>  Argument(bobj(
//    BField(tj._1,BValue(jlog(tj._2)))
//  )) }
//
